...
```{r, include=FALSE}
wetland <- read_csv("week10/FAIR_assignment/wetland_data/Great_Plains_Playas_Macroinvert_Counts.csv")
```
...
```{r, include=FALSE}
insect <- readxl::read_excel("week10/FAIR_assignment/insect_data/Data_Toivonen_et_al__2024_AFE.xlsx")
```
